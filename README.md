...
Swin-sprite 变体在 **UCI Electricity** 数据集上（$L=96, T=96$ 配置下），Test MSE 达到了 **0.132 - 0.135**。该成绩显著优于目前主流的 iTransformer 和 PatchTST，确立了 Swin-sprite 在该数据集上的全新 SOTA 地位。
